          ...
          color: "#FFF",
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    ...
                    <TableCell align="right" style={{color: "#FFF"}}>Descrição</TableCell>
                    <TableCell align="right" style={{color: "#FFF"}}>Data de Início</TableCell>
                    <TableCell align="right" style={{color: "#FFF"}}>Data de Finalização</TableCell>
                    <TableCell align="right" style={{color: "#FFF"}}>Status</TableCell>
                    <TableCell align="right" style={{color: "#FFF"}}>Recurso</TableCell>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right" style={{color: "#FFF"}}>{row.descricaoTarefa}</TableCell>
                      <TableCell align="right" style={{color: "#FFF"}}>{moment(row.inicioTarefa).format("DD/MM/YYYY")}</TableCell>
                      <TableCell align="right" style={{color: "#FFF"}}>{moment(row.fimTarefa).format("DD/MM/YYYY")}</TableCell>
                      <TableCell align="right" style={{color: "#FFF"}}>{row.statusTarefa}</TableCell>
                      <TableCell align="right" style={{color: "#FFF"}}>{row.recursoTarefa}</TableCell>
